...
let navigate = useNavigate();
  function handleClick() {
    ...
    return(
        <div className="UserhoverCard" style={{backgroundColor:"white",width:"250px",height:"290px",textAlign:"center",border:"1px solid rgba(0,0,0,0.3)",borderRadius:"5px",cursor:"pointer"}} onClick={handleClick}>
            {console.log(user)}
